      ...
      <section className="bg-black text-white pt-32 pb-12 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 relative">
          ...
          <Reveal className="flex-shrink-0">
            <img
              src="/images/teachers/yaashvi.jpg"
              alt="Yaashvi Kedia"
            ...
            {["10", "20", "36"].map((num) => {
              ...
              return (
                <button
                  ...
                  className={`pb-3 text-xl md:text-2xl font-semibold transition-colors ${activeTab ? "text-red-600" : "text-gray-700 hover:text-black"
                    }`}
                >
                  {num} Sessions
                  <span
                    className={`block mx-auto mt-2 h-[3px] rounded bg-red-600 transition-all duration-300 ${activeTab ? "w-36" : "w-0 group-hover:w-10"
                      }`}
                  />
                </button>
              );
